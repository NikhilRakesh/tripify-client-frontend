...
const PrivacyPage = () => {
    return (
        <div className='bg-gray-100 min-h-screen py-12 px-5 space-y-8  text-lg'>
            ...
            <h4 className='font-bold text-2xl'>What Personal Information We Collect</h4>
            <p>
                The types of personal information we obtain about you depends on how you interact with our Site and use our Services. When we use the term "personal information", we are referring to information that identifies, relates to, describes or can be associated with you. The following sections describe the categories and specific types of personal information we collect.
            </p>
            <h5 className='font-bold text-2xl'>Information We Collect Directly from You</h5>
            <p>
            ...
            <h5 className='font-bold text-2xl'>Information We Collect through Cookies</h5>
            <p>
            ...
            <h5 className='font-bold text-2xl'>Information We Obtain from Third Parties</h5>
            <p>
            ...
            <h3 className='font-bold text-2xl'>How We Use Your Personal Information</h3>
            <p>
            ...
            <p>
                Like many websites, we use Cookies on our Site. For specific information about the Cookies that we use related to powering our store with Shopify, see Shopify Cookies
            </p>
            ...
            <h3 className='font-bold text-2xl'>How We Disclose Personal Information</h3>
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        <td>Identifiers</td>
                        <td>such as basic contact details and certain order and account information</td>
                    </tr>
                    <tr>
                        <td>Commercial information</td>
                        <td>such as order information, shopping information, and customer support information</td>
                    </tr>
                    <tr>
                        <td>Internet or other similar network activity</td>
                        <td>such as Usage Data</td>
                    </tr>
                </tbody>
            </table>
            ...
            <h3 className='font-bold text-2xl'>Third Party Websites and Links</h3>
            ...
            <h3 className='font-bold text-2xl'>Children’s Data</h3>
            ...
            <h3 className='font-bold text-2xl'>Security and Retention of Your Information</h3>
            ...
            <h3 className='font-bold text-2xl'>Your Rights and Choices</h3>
            ...
            <ul>
                ...
                <li>Managing Communication Preferences: We may send you promotional emails, and you may opt out of receiving these at any time by using
                    <p>the unsubscribe option displayed in our emails to you. If you opt out, we may still send you non-promotional emails, such as those about your account or orders that you have made.</p>
                </li>
            </ul>
            ...
            <h3 className='font-bold text-2xl'>International Users</h3>
